...
MainWindow::MainWindow()
{
    ...
    mainTimerLabel = new QLabel(this);
    mainTimerLabel->setText("00:00:00");
    mainTimerLabel->setGeometry(40, 100, 130, 40);

    QFont font = mainTimerLabel->font();
    font.setPixelSize(32);
    mainTimerLabel->setFont(font);

    QLabel* desc = new QLabel("Description", this);
    desc->setGeometry(260, 60, 70, 20);

    mainTimerDescriptionLabel = new QTextEdit(this);
    mainTimerDescriptionLabel->setGeometry(250, 80, 230, 100);
    mainTimerDescriptionLabel->setReadOnly(true);
...
void MainWindow::setToolBar()
{
    ...
    timelabel = new QLabel(QTime::currentTime().toString());
    startTimer(1000);
...
void MainWindow::timerEvent(QTimerEvent *e)
{
    ...
    if(timers.size() > 0){
        ...
        mainTimerLabel->setText(timers[0].getTime().toString());
        mainTimerDescriptionLabel->setText(timers[0].getDescription());
        ...
        mainTimerDescriptionLabel->setText("\0");
    }
}
    ...
    void MainWindow::timeoutWindow()
    {
        ...
        timeoutDescLbl->setText(timers[0].getDescription());
    ...
    void MainWindow::toEditWindow()
    {
        ...
        for(int i = 0; i < timers.size(); i++){
            if(tmp == timers[i].getTime().toString()){
                ...
                buffer.setDescription(timers[i].getDescription());
            }
        }
    ...
    void MainWindow::addTimerBtnClicked()
    {
        ...
        if(timers.empty()){
            mainTimerLabel->setText("00:00:00");
            mainTimerDescriptionLabel->setText(" ");
        } else {
            mainTimerLabel->setText(timers[0].getTime().toString());
            mainTimerDescriptionLabel->setText(timers[0].getDescription());
        }
    ...
    void MainWindow::editTimerBtnClicked()
    {
        ...
        timers[positionToEdit].setDescription(editDescEdit->toPlainText());

        buffer.setTime(time);
        buffer.setDescription(editDescEdit->toPlainText());
